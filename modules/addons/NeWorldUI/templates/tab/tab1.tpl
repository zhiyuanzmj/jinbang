<div class="form-group">
    ...
    <div class="col-sm-10">
	    <div class="row">
		    ...
		    <div class="col-sm-3 mode{if $setting['thememode'] eq "dark"} selected{/if}" data-mode="dark">
				<a class="box" style="background-image: url('{$assets}assets/img/thememode1.png');">Dark</a>
		    </div>
		    <div class="col-sm-3 mode{if $setting['thememode'] eq "light"} selected{/if}" data-mode="light">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
	    <div class="row">
		    ...
		    <div class="col-sm-3 mode{if $setting['loginmode'] eq "default"} selected{/if}" data-mode="default">
				<a class="box" style="background-image: url('{$assets}assets/img/loginmode1.png');">样式一</a>
		    </div>
		    <div class="col-sm-3 mode{if $setting['loginmode'] eq "especial"} selected{/if}" data-mode="especial">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
	    <div class="row">
		    ...
		    <div class="col-sm-3 mode{if $setting['cartmode'] eq "light"} selected{/if}" data-mode="light">
				<a class="box" style="background-image: url('{$assets}assets/img/cartmode1.png');">样式一</a>
		    </div>
		    <div class="col-sm-3 mode{if $setting['cartmode'] eq "dark"} selected{/if}" data-mode="dark">
...
<div class="form-group">
    <label for="homepagemode" class="col-sm-2 control-label">用户中心样式</label>
    <div class="col-sm-10">
	    <div class="row">
		    <input type="hidden" name="homepagemode" value="{$setting['homepagemode']}" />
		    <div class="col-sm-3 mode{if $setting['homepagemode'] eq "Horizontal"} selected{/if}" data-mode="Horizontal">
				<a class="box" style="background-image: url('{$assets}assets/img/cartmode1.png');">样式一</a>
		    </div>
		    <div class="col-sm-3 mode{if $setting['homepagemode'] eq "Three"} selected{/if}" data-mode="Three">
				<a class="box" style="background-image: url('{$assets}assets/img/cartmode2.png');">样式二</a>
		    </div>
	    </div>
    </div>
