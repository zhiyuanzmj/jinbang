{if $header eq "side"}
<div class="o-page__sidebar js-page-sidebar {if $uiManager['thememode']}js-page-{$uiManager['thememode']}{/if}">
	<div class="c-viery">请前往 模块插件 激活 UI Manage 然后刷新</div>
    <div class="c-sidebar {if $uiManager['thememode']}c-sidebar--{$uiManager['thememode']}{/if}">

        <a class="c-sidebar__brand" href="{$systemurl}">
            {$companyname}
        </a>
	   ...
	   <!-- Navigation items that will be collapes and toggle in small viewports -->
	    ...
	    <div class="c-dropdown dropdown u-ml-large">
	        <a  class="c-avatar c-avatar--xsmall has-dropdown dropdown-toggle" href="#" id="dropdwonMenuAvatar" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	            <img class="c-avatar__img" src="//gravatar.loli.net/avatar/{$clientsdetails.email|md5}?s=100&d={$systemurl}templates/{$template}/assets/img/default_family.jpg" alt="User's Profile Picture">
	        </a>
