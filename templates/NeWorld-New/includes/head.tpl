...
<link href="https://cdnjs.loli.net/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css?v={$versionHash}" rel="stylesheet">
...
<link href="{$WEB_ROOT}/templates/{$template}/assets/css/custom.css?71" rel="stylesheet">
