...
<div class="cartbk">
		<div class="text-center carttb">
			<a href="cart.php" class="fl {if $loggedin}{if $registerdomainenabled || $condlinks.domaintrans}col-sm-4 col-xs-4{else}col-sm-6 col-xs-6{/if}{else}col-sm-6 col-xs-6{/if}">
				{$LANG.gwczjcp}
			</a>
			{if $registerdomainenabled && $condlinks.domaintrans}
							<a href="cart.php?a=add&domain=register" class="flac {if $loggedin}col-sm-4 col-xs-4{else}col-sm-6 col-xs-6{/if}">{$LANG.registerdomain}</a>
		...
		<div class="cart-k">
			...
			<div class="row">
			<div class="cart-l col-sm-2"><i class="fa fa-clone"></i>{$LANG.gwcbt1}</div>
			<div class="cart-r cpfl col-sm-10">
				<ul class="nav nav-tabs">
					{if $registerdomainenabled}
					<li{if $templatefile eq "domainregister"} class="active"{/if}>
						<a href="cart.php?a=add&domain=register">{$LANG.registerdomain}</a>
					</li>
					{/if}
					{if $condlinks.domaintrans}
					<li{if $templatefile eq "domaintransfer"} class="active"{/if}>
						<a href="cart.php?a=add&domain=transfer">{$LANG.ordertransferdomain}</a>
					</li>
					{/if}
					{if $loggedin}
					<li{if $templatefile eq "domainrenewals"} class="active"{/if}>
						<a href="cart.php?a=add&domain=renewals">{$LANG.domainrenew}</a>
					</li>
					{/if}
				</ul>
			</div>
