...
<div id="order-standard_cart" style="margin-bottom: 80px;">
	<div class="cartbk">
		<div class="text-center carttb">
			<div class="cppztb">
				<i class="fa fa-gears" style="margin-right: 8px;color: #00C0FA;"></i>{$LANG.cartpzcpym}
			</div>
		</div>
		<div class="cart-k">
    ...
    <div class="row">
			...
			<div class="cart-l col-sm-2"><i class="si si-globe"></i>{$LANG.domaincheckerchoosedomain}</div>
