...
$_LANG['hyhl'] = "欢迎回来，";
$_LANG['zcdl'] = "注册 / 登录";
$_LANG['hyzxhdtz'] = "活动 & 通知";
$_LANG['syzdmc'] = "账单";
$_LANG['wfkzje'] = "未付款";
$_LANG['nmywzfzd'] = "您没有未支付账单";
$_LANG['nygmcp'] = "您已购买的产品 - Click to View";
$_LANG['glyzcym'] = "管理您已注册的域名";
$_LANG['zfwzfzd'] = "为避免服务中断，请尽快支付您的未付账单";
$_LANG['glbjd'] = "您的报价单 - Click to View";
$_LANG['syaffinfo'] = "每笔成功交易返 <b>10%</b> 订单金额！";
$_LANG['jzxg'] = "1";		//	是否开启页面加载特效，如果开启请填写“1”，如果关闭请填写“0”。默认为开启
$_LANG['hid'] = "1";		//	控制注册简化是否开启。如果开启，此处值请填 “display:none” ，否则请留空！（默认为简化注册开启）
						//	如果开启注册简化，下面的4个值请一定要填写。如果不开启，则务必留空。
$_LANG['sf'] = "省份";		//	如果上面开始了注册简化，此处请填默认省份，比如：“湖北”。如果上面没有开启，请务必不要添加内容，留空即可！
$_LANG['cs'] = "城市";		//	如果上面开始了注册简化，此处请填默认城市，比如：“武汉”。如果上面没有开启，请务必不要添加内容，留空即可！
$_LANG['yb'] = "123456";		//	如果上面开始了注册简化，此处请填默认邮编，比如：“518057”。如果上面没有开启，请务必不要添加内容，留空即可！
$_LANG['dz1'] = "详细地址栏1";		//	如果上面开始了注册简化，此处请填默认地址，比如：“某某镇某某路某号”。如果上面没有开启，请务必不要添加内容，留空即可！
...
$_LANG['cdkzt'] = "控制台";
$_LANG['cdkfzx'] = "客服中心";
$_LANG['cddbwz'] = "立即加入我们，开启云计算之旅！";
$_LANG['cddh'] = "+86 135 5555 6666";
$_LANG['cdyx'] = "support@whmcs.top";
$_LANG['cdjs'] = "我们是一家专业提供WHMCS主题模板、扩展插件的网站，并且根据您的需求提供定制服务！";
$_LANG['cdba'] = "粤ICP备：xxxx-xxx号";
$_LANG['cdsm11'] = "专注于WHMCS主题、插件定制开发";


// 产品管理页
$_LANG['dedicatedip'] = "独立 IP"; 
$_LANG['serverip'] = "服务器地址";
$_LANG['mangerhosting'] = "管理产品";
$_LANG['vps'] = "VPS/云服务器";
$_LANG['xnzj'] = "虚拟主机";
$_LANG['fxzj'] = "分销主机";
$_LANG['qtcp'] = "其他产品";
$_LANG['gmsm'] = "您目前尚未开通任何产品";
$_LANG['gmsm1'] = "我们提供高效稳定的VPS/云服务器、独立服务器租用、虚拟主机以及经销商主机。<br>您可以轻松的在我们提供的产品上部署运行您的项目，为您的项目提供高效的管理和运行效率！";
$_LANG['gmsm2'] = "产品帮助文档";
$_LANG['gmsm3'] = "立即创建主机";
$_LANG['gl'] = "概览";
$_LANG['xfkg'] = "1";		//续费按钮开关，如果显示续费按钮，请填“1”，否则请填“0”。 续费插件为NeWorld开源续费插件，请前往neworld官方git自行下载！
$_LANG['ghkg'] = "1";		//过户按钮开关，如果显示过户按钮，请填“1”，否则请填“0”。 续费插件为NeWorld开源过户插件，请前往neworld官方git自行下载！
...
// 在线充值页
$_LANG['othertol'] = "其他金额";
$_LANG['othertol1'] = "请输入金额";
$_LANG['huabei'] = "f2falipay";			// 蚂蚁花呗支付接口LOGO图标的支付接口名称，请注意：此处填写您相应的接口名称。以下4种同样
$_LANG['alipay'] = "DoiAM_alipay";		// 支付宝支付接口的LOGO图标的支付接口名称
$_LANG['wepay'] = "DoiAM_wepay";		// 微信支付接口的LOGO图标的支付接口名称
$_LANG['qqpay'] = "DoiAM_qqpay";		// QQ钱包支付接口的LOGO图标的支付接口名称
$_LANG['paypal'] = "paypal";			// 贝宝支付接口的LOGO图标的支付接口名称
$_LANG['je1'] = "100";					// 5种固定充值金额的设置，建议设置为整数。
$_LANG['je2'] = "500";					// 5种固定充值金额的设置，建议设置为整数。
$_LANG['je3'] = "1000";					// 5种固定充值金额的设置，建议设置为整数。
$_LANG['je4'] = "5000";					// 5种固定充值金额的设置，建议设置为整数。
$_LANG['je5'] = "10000";				// 5种固定充值金额的设置，建议设置为整数。
$_LANG['xzorderpaymentmethod'] = "请选择付款方式";

// 批量付款页面
$_LANG['invoicestotaldue1'] = "账单总金额";

// 推广页面
$_LANG['afflink'] = "我的链接";
$_LANG['affyj'] = "我的佣金";
$_LANG['affjl'] = "推广记录";
$_LANG['afflink1'] = "5%";		// 返现金额比例，说明作用
$_LANG['afflink2'] = "100";		// 满多少佣金可提醒，说明作用。


// 工单页面
$_LANG['s1'] = "1";	// 售前咨询图标，此处填写售前咨询的 "ID"，如无此部门，请留空。
					// 查看部门ID，请进入提交工单页面，鼠标移至部门上，浏览器下方会出现一个连接如：submitticket.php?step=2&deptid=1 这里：deptid=1 里的"1"就是该部门ID。以下等同此设置
$_LANG['s2'] = "2";	// 技术支持图标，此处填写技术支持的 "ID"，如无此部门，请留空。
$_LANG['s3'] = "3";	// 财务部门图标，此处填写财务部门的"ID"，如无此部门，请留空。
$_LANG['s4'] = "7";	// 备案服务图标，此处填写备案服务的"ID"，如无此部门，请留空。
$_LANG['s5'] = "";	// 会员账户图标，此处填写会员账户的"ID"，如无此部门，请留空。
$_LANG['s6'] = "";	// 投诉建议图标，此处填写投诉建议的"ID"，如无此部门，请留空。
$_LANG['ticknum'] = "3";	// 控制客服部门一排的个数，数值请填写 "3" 或 "4"，其他数值会使界面非常非常难看！填数值 "3"（默认）则一排显示4个客服部门，填数值 "4" 则一排显示3个客服部门。
$_LANG['tickifo'] = "请选择客服部门<Br><span class=\"h5 text-muted\">温馨提示：为了更快解决问题，请在提交工单前先搜索查看我们的帮助文档是否有您问题的答案。</span>";
$_LANG['gtjl'] = "沟通记录";
...
//
//	购物车功能设置以及文字
//	请仔细查看后面的注释说明，按照说明来设置，否则可能会照成显示出错
//
//	本模板购物车分类设置需要这里的设置和whmcs后台 产品组名称 （请注意，是产品组名称）的设置相配合才能达到最佳效果，具体设置可以安装说明里的教程图片！
//	本模板购物车分类设置其实是将产品组分类，具体请看教程图片和演示站
//
// **************************

// ====== 购物车首页产品分类设置开始  ============
// 说明：一共预置有8个分类供您使用。所有分类设置方式均与分类一相同，注释说明我就就写分类一了，后面的7个请照着设置即可！
//	分类1
$_LANG['fl1kg'] = "1";				//	分类一的开关，设置为“1”为启用该分类，如不启用此分类请不填或者填“0”
$_LANG['fl1'] = "vps";				//	分类一字段名，设置字段名请千万不要使用中文和特殊字符，最好为英文或英文+数字，最好是英文在前面。
									//	请注意：这里设置字段名后，在whmcs后台设置产品组名称（请注意是产品组名称）时，将需要归类到此分类的产品组名称的第二个字段填写为此字段名！！！如果本说明文字不清楚的话，请查阅安装使用帮助的相关教程图片
$_LANG['fl1name'] = "云服务器";		//	前台显示的分类名称，比如：VPS、云服务器、虚拟主机等等之类的，就是你产品的类型
//分类2
$_LANG['fl2kg'] = "1";				
$_LANG['fl2'] = "dedi";				
$_LANG['fl2name'] = "独立服务器";		
...
$_LANG['cart24'] = "两年";
$_LANG['cart36'] = "三年";
$_LANG['nfyhwz'] = "年付实例享85折优惠";
$_LANG['lnfyhwz'] = "购买两年享内存翻倍，实例75折";
$_LANG['snfyhwz'] = "三年享内存和流量翻倍，实例6折";
$_LANG['cartpzcp'] = "配置产品";
$_LANG['cartxfjgp'] = "续费价格";
$_LANG['cartjd'] = "可用区";
$_LANG['carttc'] = "实例";
$_LANG['gwczjcp'] = "主机产品";
$_LANG['gwcth'] = "新春特惠";
...
$_LANG['gwctjcp'] = "荐";
$_LANG['gwcbt1'] = "域名操作";
$_LANG['gwcbtsm1'] = "我们为您提供安全、稳定、可信赖的基础计算产品";
$_LANG['hostnameqz'] = "WMTOP";		// VPS产品配置设置 主机名 的前缀
$_LANG['hostos'] = "系统";
$_LANG['hostlt'] = "地域/节点";
$_LANG['hostcpu'] = "额外加 CPU";
$_LANG['hostmm'] = "额外加 RAM";
$_LANG['hostram'] = "内存";
$_LANG['hostnetwork'] = "带宽/网络";
$_LANG['hostds'] = "额外加 硬盘";
$_LANG['carthdd'] = "硬盘";
$_LANG['hostbw'] = "流量";
$_LANG['cartcpu'] = "处理器";
$_LANG['hostdlip'] = "额外独立IP";
$_LANG['cartip'] = "IP";
$_LANG['hostmb'] = "应用程序";
$_LANG['cartpzcpym'] = "配置产品域名";
$_LANG['cartqrdd'] = "确认订单";
$_LANG['cartjz'] = "结账";
$_LANG['cartqh'] = "哎呀，缺货啦 ";
...
$_LANG['supportticketsheader'] = "您可以在此提交您遇到的问题，客服人员在收到后会尽快回答。<br/><br/><b>使用说明：</b><br/>1. 请先阅读常见问题，并合理使用搜索引擎，您的问题也许很普遍，已经在网上被回答了很多次，直接找到答案会更加节省您的时间。<br/>2. 请选择正确的部门提交您的问题，每个部门所处理的具体事项在部门名称后有具体说明。<br/>3. 3.售前咨询，财务部门的工作时间为每天 10:00-19：00。<br/><br/><b>服务承诺：</b><br/>4.技术支持7x24小时在线，若未能及时回复，请联系右侧在线QQ咨询。<br/><br/><b>请在此选择受理您提问的部门：</b><br/>";
...
$_LANG['subaccountpermsorders'] = "产品订购/升级/取消";
...
$_LANG['pricing']['browseExtByCategory'] = "按类别浏览扩展程序";
$_LANG['pricing']['register'] = "首年价格";
$_LANG['pricing']['transfer'] = "转移价格";
$_LANG['pricing']['renewal'] = "续费价格";
$_LANG['pricing']['selectExtCategory'] = "请从上面选择一个类别。";

$_LANG['navStore'] = "产品购买";
$_LANG['navBrowseProductsServices'] = "浏览全部产品";
...
$_LANG['navMarketConnectService']['spamexperts'] = "邮箱服务";

$_LANG['store']['emailServices']['title'] = "邮箱服务";
$_LANG['store']['ssl']['title'] = "SSL 证书";
$_LANG['store']['ssl']['dv']['title'] = "DV SSL 证书";
$_LANG['store']['ssl']['ov']['title'] = "OV SSL 证书";
$_LANG['store']['ssl']['ev']['title'] = "EV SSL 证书";
$_LANG['store']['ssl']['wildcard']['title'] = "Wildcard 通配符 SSL 证书";
$_LANG['store']['websiteBuilder']['title'] = "Website Builder";
$_LANG['store']['configure']['configureProduct'] = "配置产品";

$_LANG['store']['ssl']['dv']['tagline'] = "适用于个人站点，只需短短几分钟，即可全方位保护您的网站！";
$_LANG['store']['ssl']['dv']['descriptionTitle'] = "什么是 DV SSL 证书?";
$_LANG['store']['ssl']['dv']['descriptionContent'] = "<p>DV SSL证书仅验证网站域名所有权，优点是可在数分钟内快速颁发，能保证加密传输数据，不足之处是无法证明网站的真实身份。访问网站的访客只能知道这个网站是在运营的，却不知是谁！</p>";

$_LANG['store']['ssl']['ov']['tagline'] = "高保证的SSL，向网站方可显示您的认证身份";
$_LANG['store']['ssl']['ov']['descriptionTitle'] = "什么是 OV SSL 证书?";
$_LANG['store']['ssl']['ov']['descriptionContent'] = "<p>OV SSL证书，对网站数据进行加密,对网站所有者进行严格的身份审核验证,要求其提供可信身份证明。经过CA严格验证身份后方可颁发OV SSL证书，访客可以看到证书的相关信息！涉及客户隐私信息保护和账号密码安全的网站，建议使用OV SSL证书。</p>";

$_LANG['store']['ssl']['ev']['tagline'] = "激活绿色地址栏以获得最高的信任和经济收益";
$_LANG['store']['ssl']['ev']['descriptionTitle'] = "什么是 EV SSL 证书?";
$_LANG['store']['ssl']['ev']['descriptionContent'] = "<p>EV SSL证书，属于扩展验证型，不仅验证企业型证书需要验证的资料，还要进行扩展验证，遵循全球统一的严格身份验证标准，数据加密、绿色地址栏显示企业名称，是目前业界安全级别最高的SSL证书。目前大型的互联网金融以及涉及到交易支付的网站，建议使用EV SSL证书。</p>";

$_LANG['store']['ssl']['wildcard']['tagline'] = "在单个证书上保证一个网域所有子域名的安全。";
$_LANG['store']['ssl']['wildcard']['descriptionTitle'] = "什么是 Wildcard SSL 通配符证书?";
$_LANG['store']['ssl']['wildcard']['descriptionContent'] = "<p>通配符证书可以保护一个域名下同级子域名，不限制该级子域名数量，且添加新的该级子域名无须重新审核和另外付费，节约了大量的时间和金钱成本。</p>";

$_LANG['store']['websiteBuilder']['headline'] = "建设一个网站，从未如此方便";
$_LANG['store']['websiteBuilder']['tagline'] = "使用强大的自由拖放模块工具创建完美的网站";
$_LANG['store']['websiteBuilder']['introduction'] = "Weebly 网站制作工具可以轻松创建一个功能强大的专业网站，无需任何技术技能。博客、商店建立在线业务、超过3000万企业家和小企业已经通过Weebly 建设了属于他们的网站。";

$_LANG['store']['emailServices']['headline'] = "邮件反垃圾，专为您打造的邮局";
$_LANG['store']['emailServices']['tagline'] = "真正得到您收件箱的自主控制权";
$_LANG['store']['emailServices']['blockSpamHeadline'] = "在任何邮件达到您的收件箱之前，可以阻止超过99.9％的垃圾、病毒，以及恶意邮件。";

$_LANG['navManageSsl'] = "管理 SSL 证书";

$_LANG['invoicesPaymentPending'] = "付款审核中";

$_LANG['ssl']['changeApproverEmail'] = "更改证书签发邮箱";
$_LANG['ssl']['reissueCertificate'] = "补发证书";
$_LANG['ssl']['retrieveCertificate'] = "检查证书";

$_LANG['upgradeCredit'] = "提升信用";
$_LANG['upgradeCreditDescription'] = "计算依据基于当前账单周期中 :daysRemaining (剩余天数) / :totalDays (总天数).";

$_LANG['orderForm']['domainExtensionTransferNotSupported'] = "目前我们暂时不支持将此域名转入我们的系统，请尝试其他域名.";
$_LANG['orderForm']['domainExtensionTransferPricingNotConfigured'] = "由于资格与权限问题，该域名无法转入我们的系统，请尝试其他域名.";

$_LANG['remoteAuthn']['success'] = "成功!";
$_LANG['remoteAuthn']['errorExclamation'] = "错误!";
$_LANG['remoteAuthn']['error'] = "错误";
$_LANG['remoteAuthn']['linkInitiated'] = "链接已开启!";
$_LANG['remoteAuthn']['areYouSure'] = "确定吗?";
$_LANG['remoteAuthn']['yesUnlinkIt'] = "是的，取消它!";
$_LANG['remoteAuthn']['unlinked'] = "链接已解除!";
$_LANG['remoteAuthn']['unavailable'] = "暂时不可用。请稍后再试。.";
$_LANG['remoteAuthn']['connectError'] = "我们无法连接您的帐户。请与系统管理员联系。";
$_LANG['remoteAuthn']['completeSignIn'] = "请完成登录进行服务提供商的选择。";
$_LANG['remoteAuthn']['redirecting'] = "自动登录成功！正在重定向";
$_LANG['remoteAuthn']['accountNowLinked'] = "您的账户已被链接到用户名为 :displayName 的账户中.";
$_LANG['remoteAuthn']['oneTimeAuthRequired'] = "请使用已有账号完成登录以链接服务. 只需操作一次即可.";
$_LANG['remoteAuthn']['completeRegistrationForm'] = "请填写以下注册表格。";
$_LANG['remoteAuthn']['completeNewAccountForm'] = "请完善您的新账号信息.";
$_LANG['remoteAuthn']['linkedToAnotherClient'] = "这个帐号已经被连接到系统现有的另一个帐户，请在第三方身份验证提供者中选择不同的帐户。";
$_LANG['remoteAuthn']['alreadyLinkedToYou'] = "这个帐号已经连接到您的帐户上了。请在第三方身份验证提供者中选择另一个帐户。";
$_LANG['remoteAuthn']['saveTimeByLinking'] = "使用现有帐户快速连接以下服务。";
$_LANG['remoteAuthn']['unlinkDesc'] = "此操作将永久取消授权帐户。";
$_LANG['remoteAuthn']['mayHaveMultipleLinks'] = "将您的帐户与以下任何服务相关联，以简化您的登录体验。 我们只使用此信息来验证您的帐户，绝不会以您的身份发布。";
$_LANG['remoteAuthn']['titleSignUpVerb'] = "注册";
$_LANG['remoteAuthn']['titleOr'] = "或";
$_LANG['remoteAuthn']['titleLinkedAccounts'] = "已链接的帐户";
$_LANG['remoteAuthn']['provider'] = "提供商";
$_LANG['remoteAuthn']['name'] = "姓名";
$_LANG['remoteAuthn']['emailAddress'] = "邮箱";
$_LANG['remoteAuthn']['actions'] = "Actions";
$_LANG['remoteAuthn']['noLinkedAccounts'] = "找不到关联帐户";
$_LANG['remoteAuthn']['signInWith'] = '使用 :provider 登录';
$_LANG['remoteAuthn']['connectWith'] = '与 :provider 账户连接';
$_LANG['remoteAuthn']['signUpWith'] = '使用 :provider 注册';

$_LANG['unlink'] = "解除链接";

$_LANG['invoicePaymentSuccessAwaitingNotify'] = "感谢您完成付款流程。 我们正在等待通知，确认您刚才的付款。 收到邮件后，我们会立即向您发送电子邮件确认信。";

$_LANG['errorPage']['404']['title'] = "糟糕!";
$_LANG['errorPage']['404']['subtitle'] = "我们找不到该页面";
$_LANG['errorPage']['404']['description'] = "请尝试使用以下选项进行导航。";
$_LANG['errorPage']['404']['home'] = "主页";
$_LANG['errorPage']['404']['submitTicket'] = "联系支持";

$_LANG['creditCard']['removeDescription'] = "您确定要移除信用卡详细信息吗？";

$_LANG['marketConnect']['weebly']['ftpHost'] = "FTP主机";
$_LANG['marketConnect']['weebly']['ftpUsername'] = "FTP用户名";
$_LANG['marketConnect']['weebly']['ftpPassword'] = "FTP密码";
$_LANG['marketConnect']['weebly']['ftpPath'] = "FTP目录";
$_LANG['marketConnect']['weebly']['updateFtp'] = "更新FTP凭据";
$_LANG['marketConnect']['weebly']['manage'] = "登录到Weebly";

$_LANG['domainChecker']['contactSupport'] = "联系支持购买";

$_LANG['cart']['availableCreditBalance'] = "您的可用信用额度为 :amount.";
$_LANG['cart']['applyCreditAmount'] = "扣除信用额度 <span>:amount</span> 来支付此订单，另外通过以下所选的付款方式支付余款。";
$_LANG['cart']['applyCreditAmountNoFurtherPayment'] = "扣除信用额度 <span>:amount</span> 来支付此订单，不再进一步付款。";
$_LANG['cart']['applyCreditSkip'] = "不要从我的信用额度中扣除任何款项来支付这个订单，我将使用下面选择的付款方式全额付款。";

//Optimized by Jonvi & Thanks kaneawk
